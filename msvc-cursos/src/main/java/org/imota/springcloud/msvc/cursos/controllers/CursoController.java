...
public class CursoController {
    ...
    public ResponseEntity<?> asignarUsuario(@RequestBody Usuario usuario,
                                            @PathVariable(name = "cursoId") Long cursoId){
        Optional<Usuario> o;
        try{
            ...
            return ResponseEntity.status(HttpStatus.NOT_FOUND)
                    .body(Collections
                            .singletonMap("mensaje", "No existe el usuario por id " +
                                    "o ha ocurrido un error interno: "+e.getMessage()));
        }
